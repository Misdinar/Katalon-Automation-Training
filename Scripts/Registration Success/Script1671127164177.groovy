...
WebUI.verifyElementText(findTestObject('Page_1 new message/pesan_register'), 'Thank you for registering. Your account has to be activated before you can login. Please check your email.')
